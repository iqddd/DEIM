...
class YAMLConfig(BaseConfig):
    ...
    def lr_scheduler(self, ) -> optim.lr_scheduler.LRScheduler:
        if self._lr_scheduler is None and self.yaml_cfg.get('lr_scheduler', None) is not None:
    ...
    def lr_warmup_scheduler(self, ) -> optim.lr_scheduler.LRScheduler:
        if self._lr_warmup_scheduler is None and self.yaml_cfg.get('lr_warmup_scheduler', None) is not None:
